...
export const mockAlojamientos: Alojamiento[] = [
  {
    ...
    anfitrion: { 
      ...
      aniosComoAnfitrion: 3 
    },
    amenities: [
      { id: '1', nombre: 'Piscina', icono: '🏊' }, 
      { id: '2', nombre: 'Wifi', icono: '📶' }
    ]
  },
  {
    id: '2',
    ...
    anfitrion: { 
      ...
      aniosComoAnfitrion: 5 
    },
    // AQUÍ SE CORRIGIÓ: 'nombre' en lugar de 'font'
    amenities: [
      { id: '2', nombre: 'Wifi', icono: '📶' }, 
      { id: '3', nombre: 'Chimenea', icono: '🔥' }
    ]
  }
];